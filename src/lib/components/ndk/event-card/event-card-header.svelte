...
<script lang="ts">
  ...
  import Name from '$lib/components/ndk/user-profile/user-profile-name.svelte';
  import Field from '$lib/components/ndk/user-profile/user-profile-field.svelte';
  import Nip05 from '$lib/components/ndk/user-profile/user-profile-nip05.svelte';
