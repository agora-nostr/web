...
import ArticleCardPortrait from "./article-card-portrait.svelte";
...
export function register(renderer: ContentRenderer = defaultContentRenderer) {
	renderer.addKind(NDKArticle, ArticleCardPortrait, registration.priority);
}

// Auto-register on import
register();

export { ArticleCardPortrait };
